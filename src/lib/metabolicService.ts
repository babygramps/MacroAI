 ...
 * (`@/lib/metabolicService`) keeps working unmodified, and additionally
 * hosts the browser-console debug tooling below (moves out in Task 9).
 */

import { getAmplifyDataClient } from '@/lib/data/amplifyClient';
import { backfillMetabolicData, recalculateTdeeFromDate } from './metabolic/service';
