...
A mobile-responsive calorie and macro tracking web app built with Next.js 14, AWS Amplify Gen 2, and AI-powered food recognition.
...
- API Keys for:
  ...
  - [API Ninjas](https://api-ninjas.com/) (Free tier: 50k/month)
...
# Enter your API Ninjas key when prompted
...
│   │   ├── parseTextLog.ts  # API Ninjas + Gemini fallback
...
3. **API Ninjas Nutrition** - 50k/month free, for natural language
4. **Gemini 3 Flash** - Free tier + pay-per-use, for images/complex text
