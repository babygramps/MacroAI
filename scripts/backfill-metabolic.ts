...
console.log('  3. Backfill runs automatically via useDashboardData\'s one-time backfill');
console.log();
console.log('Or trigger it manually from the browser console/debug tooling:');
console.log();
console.log('  await backfillMetabolicData(90);');
console.log();
